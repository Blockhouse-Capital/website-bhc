...
function Row(props: { row: ReturnType<typeof createData> }) {
  ...
  let [addLiquidity, setAddLiquidity] = useState<any>(1.3943);
    ...
    <React.Fragment>
          ...
          >
            ...
            >
              <AddCircleOutlineIcon
                onClick={() => setRemLiquidity(addLiquidity + 5)}
              />
              <input
                type="number"
      ...
      {addLiquPressed !== false ? (
        ...
        >
            ...
            >
              ...
              >
                <AddCircleOutlineIcon
                  ...
                  onClick={() => setAddLiquidity(addLiquidity + 2)}
                />
                <input
                  type="number"
                  placeholder="21.20349"
          ...
          <HomeHR />
          <Box sx={{ marginBottom: "70px", marginTop: "-10px" }}>
            <ExchangeChart fromWhichPage={"blockHouseLiq"} />
          </Box>
