...
function Row(props: { row: ReturnType<typeof createData> }) {
  ...
  const [addOrRemoveLiquPressed, setAddOrRemoveLiquPressed] = useState("");
  let [addLiquidity, setAddLiquidity] = useState<any>(21.20349);

  return (
    <React.Fragment>
      {addOrRemoveLiquPressed !== "" ? (
        <Box
          sx={{
        ...
        >
          <Close
            ...
            onClick={() => setAddOrRemoveLiquPressed("")}
          />
          <Typography
            component="h1"
            variant="h6"
          ...
          >
            ...
            >
              <AddCircleOutlineIcon
                onClick={() => setAddLiquidity(addLiquidity + 5)}
              />
              <input
                type="number"
                ...
                onChange={(v) => setAddLiquidity(v.target.value)}
              />
          ...
          >
            {addOrRemoveLiquPressed === "addLiq"
              ? "Add Provide Liquidity"
              : "Remove Provide Liquidity"}
          </Button>
        </Box>
      ) : (
        ""
                  ...
                  <Grid item xs={4}>
                    ...
                    <center>
                      <Button
                        ...
                        onClick={() => setAddOrRemoveLiquPressed("addLiq")}
                      >
                        Add liquidity
                      </Button>
                    </center>
                  ...
                  <Grid item xs={4}>
                    ...
                    <center>
                      <Button
                        ...
                        onClick={() => setAddOrRemoveLiquPressed("rmvLiq")}
                      >
