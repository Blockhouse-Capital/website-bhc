      ...
      <Drawer variant="permanent" open={open}>
        ...
        >
          <ListItem disablePadding sx={{ color: "#FFFFFF99", height: "50px" }}>
            <ListItemButton>
              <ListItemIcon sx={{ color: "#FFFFFF99", marginRight: "-20px" }}>
                <img src={sideBarNavHomeIcon} style={{ width: "25px" }} />
                {/* <img
          ...
          <ListItem disablePadding sx={{ color: "#FFFFFF99", height: "50px" }}>
            <ListItemButton>
              <ListItemIcon sx={{ color: "#FFFFFF99", marginRight: "-20px" }}>
                <img src={sideBarDealsIcon} style={{ width: "22px" }} />
                {/* <img
          ...
          <ListItem disablePadding sx={{ color: "#FFFFFF99", height: "50px" }}>
            <ListItemButton>
              <ListItemIcon sx={{ color: "#FFFFFF99", marginRight: "-20px" }}>
                <img src={auctionIcon} style={{ width: "25px" }} />
                {/* <img
        ...
        >
          ...
          >
            ...
            >
              <ListItemButton>
                <ListItemIcon sx={{ color: "#FFFFFF99", marginRight: "-20px" }}>
                  <img src={sideBarProductsIcon} width="20px" height="20px" />
                </ListItemIcon>
                <ListItemText
                  sx={{
                    ...(!open && { display: "none" }),
            ...
            <AccordionDetails sx={{ px: 0, mt: "-1px", mb: "-7px" }}>
              ...
              >
                <ListItemIcon sx={{ color: "#FFFFFF99", marginRight: "-20px" }}>
                  <img src={structureIcon} width="20px" height="20px" />
                  {/* <img
